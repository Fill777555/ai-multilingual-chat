...
.aic-sound-item:hover {
    border-color: var(--widget-color, #667eea);
...
.aic-sound-item input[type="radio"] {
    margin: 0 10px 0 0;
}

.aic-sound-item label {
    flex: 1;
    margin: 0;
    cursor: pointer;
}
...
.aic-sound-preview:hover {
    opacity: 0.8;
}
</style>

<!-- Sound Settings Modal -->
<div id="aic-sound-modal" class="aic-modal" style="display: none;">
    <div class="aic-modal-overlay"></div>
    <div class="aic-modal-content">
        <div class="aic-modal-header">
            <h3>Выбор мелодии оповещения</h3>
            <button class="aic-modal-close">&times;</button>
        </div>
        <div class="aic-modal-body">
            <div class="aic-sound-list">
                <!-- Sounds will be added through JavaScript -->
            </div>
        </div>
    </div>
</div>
